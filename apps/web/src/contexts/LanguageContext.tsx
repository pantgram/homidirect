...
export const translations = {
  en: {
    ...
    "listForm.verificationDesc":
      "Upload a document to verify property ownership (e.g., utility bill, property tax bill, or title deed)",
  ...
  el: {
    ...
    "listForm.uploadDesc":
      "Ανεβάστε τουλάχιστον 3 φωτογραφίες (Μέγιστο 10MB η καθεμία)",
    ...
    "listForm.verificationDesc":
      "Ανεβάστε ένα έγγραφο για επαλήθευση της ιδιοκτησίας (π.χ., λογαριασμός κοινής ωφέλειας, φορολογικό έγγραφο ή τίτλος ιδιοκτησίας)",
    "listForm.clickVerification":
      "Κάντε κλικ για ανέβασμα εγγράφου επαλήθευσης",
